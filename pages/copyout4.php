...
<?php
		...
		$tech=$_POST['technology2'];
		$sess=$_POST['session2'];
		$con=mysql_connect("localhost","root","");
		mysql_selectdb("tpi",$con);
		$sabbir=mysql_query("select * from `tpi`.`student` where `session`='$sess' and `technology`='$tech'  order by session desc, roll_number asc ");
...
<a href="../index.php" style="margin-top:50px; background:#17AD6D; padding:3px;color:blue;"><blink>Back</blink></a>
	<input type="button" onclick="window.print();" value="Print"/>				</center>
				</div>
				<div style="clear:both;">
				</div>
			</div>
