...
<?php
		...
		mysql_select_db("tpi",$con);
		$qq=mysql_query("select * from `tpi`.`student` where `session`='$ses' and `technology`='$technology'  order by session desc, roll_number asc ");
...
?>
<a href="adminpage.php" style="display:block; width:100px; margin-top:50px; background:#17AD6D; padding:5px;color:blue;"><blink>Back</blink></a>
					</center>
				</div>
				<div style="clear:both;">
				</div>
